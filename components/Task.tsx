...
const Task = ({ id, content }: { id: number; content: string }) => {
	return (
        ...
        <div className=' group border rounded-md duration-100 ease-in-out border-white/20 p-2 cursor-pointer hover:border-indigo-500/20'>
					<PencilSquareIcon
						id='trash'
						className='size-7 duration-100  group-hover:text-indigo-500'
					/>
				</div>

				<div className=' group border rounded-md duration-100 ease-in-out border-white/20 p-2 cursor-pointer hover:border-red-500/20'>
					<TrashIcon
						id='trash'
						className='size-7 duration-100  group-hover:text-red-400'
					/>
				</div>
